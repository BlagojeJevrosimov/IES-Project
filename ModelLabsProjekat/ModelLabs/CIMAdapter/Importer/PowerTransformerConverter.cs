namespace FTN.ESI.SIMES.CIM.CIMAdapter.Importer
{
	...
	public static class PowerTransformerConverter
	{
		...
		public static void PopulatePowerTransformerEndProperties(FTN.PowerTransformerEnd cimPowerTransformerEnd, ResourceDescription rd)
		{
            if ((cimPowerTransformerEnd != null) && (rd != null))
            {
                PowerTransformerConverter.PopulateTransformerEndProperties(cimPowerTransformerEnd, rd);
		...
		public static void PopulateTransformerEndProperties(FTN.TransformerEnd cimPowerTransformerEnd, ResourceDescription rd)
		{
			if ((cimPowerTransformerEnd != null) && (rd != null))
			{
				PowerTransformerConverter.PopulateIdentifiedObjectProperties(cimPowerTransformerEnd, rd);
				
			}
		}
        public static void PopulateRatioTapChangerProperties(FTN.RatioTapChanger cimRatioTapChanger, ResourceDescription rd)
		{
        ...
        public static void PopulatePowerSystemResourceProperties(FTN.PowerSystemResource cimPowerSystemResource, ResourceDescription rd)
        {
            if ((cimPowerSystemResource != null) && (rd != null))
            {
				...
				/*if (cimPowerSystemResource.LocationHasValue)
				{
					...
					rd.AddProperty(new Property(ModelCode. , gid));
				}*/
		...
		public static void PopulateTerminalProperties(FTN.Terminal cimTerminal, ResourceDescription rd)
		{
			if ((cimTerminal != null) && (rd != null))
			{
				...
				{
					rd.AddProperty(new Property(ModelCode.TERMINAL_SEQUENCE_NUMBER, cimTerminal.SequenceNumber));
				}
			}
		}
